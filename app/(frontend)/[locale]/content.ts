...
const POSTER_ITEMS = [
      ...
      // — Development: Films —
      { id: 30, title: 'Our Daughter Has Disappeared', year: 2026, src: '/assets/posters/SusanPowell.jpg', tags: ['True Crime'], category: 'film' as const, description: "When Susan Powell goes missing in December of 2009, the media is swept up into the story. Based on the book \"If I Can't Have You\" by Gregg Olsen and Rebecca Morris." },
      ...
      { id: 32, title: 'Feather', year: 2026, src: '/assets/posters/Feather_Farah.png', tags: ['Drama'], category: 'film' as const, description: "The never before told story of Farrah Fawcett's life and legacy. Written by Vernon Scott, co-produced by Latigo Films." },
      ...
      { id: 34, title: "Girls Can't Play Pool", year: 2026, src: '/assets/posters/GirlsCantPlayPool.jpg', tags: ['Drama'], category: 'film' as const, subcategory: 'dramas-feature', description: 'Heather is a gifted young pool hustler who lives on the edge of chaos. When two women decide to go on the road together, their lucrative partnership leads to a deep bond. Elisabeth Rohm to direct.' },

      // — Development: Series —
      { id: 35, title: 'Undefeated', year: 2026, src: '/assets/posters/Undefeated.jpg', tags: ['Drama'], category: 'series' as const, description: "Inside the Miami Dolphins' 1972 comeback from three straight championship losses to an undefeated season. Based on Mike Freeman's book." },
      ...
      { id: 36, title: 'Korean Espionage', year: 2026, src: '/assets/posters/KoreanEspionage.png', tags: ['Thriller'], category: 'series' as const, subcategory: 'true-crime-series', description: 'When Korean Air Flight 858 is exploded by a North Korean agent, a former US soldier learns about his Japanese wife\'s darkest secret: she mentored the attacker.' },
      ...
      { id: 45, title: "Girls Can't Play Pool", year: 2026, src: '/assets/posters/GirlsCantPlayPool.jpg', tags: ['Drama'], category: 'series' as const, subcategory: 'dramas-feature', description: 'Heather is a gifted young pool hustler who lives on the edge of chaos. When two women decide to go on the road together, their lucrative partnership leads to a deep bond. Elisabeth Rohm to direct.' },
      ...
      { id: 40, title: 'The Reid Brothers', year: 2026, src: '/assets/posters/LastDay_ReidBrothers.webp', tags: ['Thriller'], category: 'series' as const, subcategory: 'dramas-series', description: 'State Police detective Conor Reid and Coast Guard Commander Tom Reid team up to track down a murderer in the seductive and wealthy enclave of the Hamptons.' },
      ...
      { id: 41, title: 'Southern Gothic', year: 2026, src: '/assets/posters/SouthernGothic.png', tags: ['Thriller'], category: 'series' as const, subcategory: 'dramas-series', description: 'When Atlanta detective Laine Badder returns to her Appalachian hometown to bury her mother, unsettling details make her suspect it wasn\'t natural causes.' },
