...
export const MEDIA = {
  posters: {
    en: [
      ...
      { id: 37, title: 'Relentless', year: 2026, src: '/placeholder.svg', tags: ['Thriller'], category: 'series' as const, subcategory: 'dramas-feature', description: '"Fatal Attraction" meets "Cape Fear." A sexy, propulsive thriller where one mistake in Mexico spirals out of control.' },
      ...
      { id: 38, title: 'Call Me Madam', year: 2026, src: '/placeholder.svg', tags: ['Drama'], category: 'series' as const, subcategory: 'dramas-series', description: "In 1961 Hot Springs, Arkansas, a savvy madam attempts to pass her high-end brothel to her Black protégé, challenging the town's racial barriers and mob control." },
      { id: 39, title: 'Swap', year: 2026, src: '/placeholder.svg', tags: ['Drama'], category: 'series' as const, subcategory: 'dramas-series', description: 'A show about contemporary marriage — love, sex, commitment, and what happens when three couples who aren\'t quite friends get a little drunk and swap.' },
      { id: 40, title: 'The Reid Brothers', year: 2026, src: '/placeholder.svg', tags: ['Thriller'], category: 'series' as const, subcategory: 'dramas-series', description: 'State Police detective Conor Reid and Coast Guard Commander Tom Reid team up to track down a murderer in the seductive and wealthy enclave of the Hamptons.' },
      ...
      { id: 41, title: 'Southern Gothic', year: 2026, src: '/placeholder.svg', tags: ['Thriller'], category: 'series' as const, subcategory: 'dramas-series', description: 'When Atlanta detective Laine Badder returns to her Appalachian hometown to bury her mother, unsettling details make her suspect it wasn\'t natural causes.' },
      { id: 42, title: 'Dispatch', year: 2026, src: '/placeholder.svg', tags: ['Thriller'], category: 'series' as const, subcategory: 'dramas-series', description: 'When a late-night call ends in a fiery truck crash, a small-town dispatcher teams up with local police to uncover a deadly cover-up. Co-production with TF1 America.' },

      // — Development: Unscripted —
      { id: 43, title: 'Horseplay', year: 2026, src: '/placeholder.svg', tags: ['Unscripted'], category: 'unscripted' as const, subcategory: 'comedy-features', description: 'When a young hobby horse competitor is assaulted, a college athlete goes undercover to solve the mystery in the unique world of competitive hobby horsing.' },
      { id: 44, title: 'Nookietown', year: 2026, src: '/placeholder.svg', tags: ['Unscripted'], category: 'unscripted' as const, subcategory: 'comedy-features', description: "When an exhausted housewife asks her divorced best friend to sleep with her husband, what starts as a joke becomes an opportunity. Based on V.C. Chickering's novel." },
    ] as MediaItem[],
    fr: [
      // — Drame —
      ...
      // — Développement : Films —
      { id: 30, title: 'Our Daughter Has Disappeared', year: 2026, src: '/assets/posters/our-sister-has-disappeared.png', tags: ['True Crime'], category: 'film' as const, description: "Quand Susan Powell disparaît en décembre 2009, les médias s'emparent de l'affaire. Basé sur le livre de Gregg Olsen et Rebecca Morris." },
      { id: 31, title: 'A Dentist to Die For', year: 2026, src: '/assets/posters/a-dentist-to-die-for.png', tags: ['True Crime'], category: 'film' as const, description: "Le chirurgien-dentiste Dr. James Ryan devient dangereusement obsédé par la reine de beauté Sarah Harris." },
      ...
      { id: 32, title: 'Feather', year: 2026, src: '/assets/posters/feather.png', tags: ['Drame'], category: 'film' as const, description: "L'histoire jamais racontée de la vie et de l'héritage de Farrah Fawcett. Écrit par Vernon Scott, coproduit par Latigo Films." },
      ...
      { id: 33, title: 'Murder-in-Law', year: 2026, src: '/placeholder.svg', tags: ['True Crime'], category: 'film' as const, subcategory: 'true-crime-movies', description: "Une riche matriarche de Miami. Une guerre de garde amère. La balle d'un tueur à gages. L'un des complots meurtriers familiaux les plus choquants d'Amérique." },
      { id: 34, title: "Girls Can't Play Pool", year: 2026, src: '/assets/posters/girls-cant-play-pool.png', tags: ['Drame'], category: 'film' as const, subcategory: 'dramas-feature', description: 'Heather est une jeune arnaqueuse de billard douée qui vit au bord du chaos. Quand deux femmes prennent la route ensemble, leur partenariat mène à un lien profond.' },

      // — Développement : Séries —
      { id: 35, title: 'Undefeated', year: 2026, src: '/assets/posters/undefeated.png', tags: ['Drame'], category: 'series' as const, description: "Le come-back des Miami Dolphins en 1972, de trois défaites consécutives en finale à une saison invaincue. Basé sur le livre de Mike Freeman." },
      ...
      { id: 36, title: 'Korean Espionage', year: 2026, src: '/assets/posters/korean-espionage.png', tags: ['Thriller'], category: 'series' as const, subcategory: 'true-crime-series', description: "Quand le vol Korean Air 858 est détruit par un agent nord-coréen, un ancien soldat américain découvre le plus sombre secret de sa femme japonaise." },
      { id: 5, title: "The Lobotomist's Wife", year: 2026, src: '/assets/works/lobotomist-wife.png', tags: ['Drame'], category: 'series' as const, subcategory: 'true-crime-series', description: "Une militante de la santé mentale tombe amoureuse d'un pionnier radical de la lobotomie, pour découvrir que son \"remède miracle\" mène à des résultats horrifiants." },
      { id: 45, title: "Girls Can't Play Pool", year: 2026, src: '/assets/posters/girls-cant-play-pool.png', tags: ['Drame'], category: 'series' as const, subcategory: 'dramas-feature', description: 'Heather est une jeune arnaqueuse de billard douée qui vit au bord du chaos. Quand deux femmes prennent la route ensemble, leur partenariat mène à un lien profond.' },
      { id: 37, title: 'Relentless', year: 2026, src: '/placeholder.svg', tags: ['Thriller'], category: 'series' as const, subcategory: 'dramas-feature', description: '"Liaison fatale" rencontre "Les Nerfs à vif." Un thriller sexy et propulsif où une erreur au Mexique dégénère.' },
      { id: 28, title: 'Silent Echo', year: 2025, src: '/assets/works/silent-echo.png', tags: ['Thriller'], category: 'series' as const, subcategory: 'dramas-feature', description: "Un an après la mort de son fils de quatre ans, Charlotte Fleming voit quelque chose qui la secoue : Sebastion, vivant, dans la publication d'un inconnu." },
      { id: 38, title: 'Call Me Madam', year: 2026, src: '/placeholder.svg', tags: ['Drame'], category: 'series' as const, subcategory: 'dramas-series', description: "En 1961 à Hot Springs, Arkansas, une tenancière avisée tente de transmettre son établissement à sa protégée noire, défiant les barrières raciales et la mafia." },
      { id: 39, title: 'Swap', year: 2026, src: '/placeholder.svg', tags: ['Drame'], category: 'series' as const, subcategory: 'dramas-series', description: "Une série sur le mariage contemporain — l'amour, le sexe, l'engagement, et ce qui arrive quand trois couples se retrouvent un peu ivres." },
      { id: 40, title: 'The Reid Brothers', year: 2026, src: '/placeholder.svg', tags: ['Thriller'], category: 'series' as const, subcategory: 'dramas-series', description: "Le détective Conor Reid et le commandant Tom Reid s'associent pour traquer un meurtrier dans l'enclave séduisante et fortunée des Hamptons." },
      { id: 23, title: 'Lie Detector', year: 2025, src: '/assets/works/lie-detector.png', tags: ['Thriller'], category: 'series' as const, subcategory: 'dramas-series', description: "Quand le FBI dévoile VERA, un détecteur de mensonges infaillible, l'interrogatrice Kara Voss et son équipe doivent le mettre à l'épreuve." },
      { id: 41, title: 'Southern Gothic', year: 2026, src: '/placeholder.svg', tags: ['Thriller'], category: 'series' as const, subcategory: 'dramas-series', description: "Quand la détective Laine Badder retourne dans sa ville natale des Appalaches pour enterrer sa mère, des détails troublants éveillent ses soupçons." },
      { id: 42, title: 'Dispatch', year: 2026, src: '/placeholder.svg', tags: ['Thriller'], category: 'series' as const, subcategory: 'dramas-series', description: "Quand un appel nocturne se termine par un accident de camion, une dispatrice s'associe à la police locale pour démasquer un complot mortel. Coproduction TF1 America." },

      // — Développement : Non-scénarisé —
      { id: 43, title: 'Horseplay', year: 2026, src: '/placeholder.svg', tags: ['Non-scénarisé'], category: 'unscripted' as const, subcategory: 'comedy-features', description: "Quand une jeune compétitrice de hobby horse est agressée, une athlète universitaire enquête sous couverture dans le monde unique du hobby horsing compétitif." },
      { id: 44, title: 'Nookietown', year: 2026, src: '/placeholder.svg', tags: ['Non-scénarisé'], category: 'unscripted' as const, subcategory: 'comedy-features', description: "Quand une mère au foyer épuisée demande à sa meilleure amie divorcée de coucher avec son mari, ce qui commence comme une blague devient une opportunité. Basé sur le roman de V.C. Chickering." },
    ] as MediaItem[],
  },
}
