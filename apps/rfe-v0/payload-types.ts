...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "EmbeddedFormBlock".
 */
export interface EmbeddedFormBlock {
  title?: string | null;
  subtitle?: string | null;
  form: number | Form;
  id?: string | null;
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        embeddedForm?: T | EmbeddedFormBlockSelect<T>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "EmbeddedFormBlock_select".
 */
export interface EmbeddedFormBlockSelect<T extends boolean = true> {
  title?: T;
  subtitle?: T;
  form?: T;
  id?: T;
