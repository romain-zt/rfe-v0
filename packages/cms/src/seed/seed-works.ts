...
const WORKS_DATA: WorkSeedItem[] = [
  ...
  { id: 6, title: 'Passing Love', year: 2026, src: '/assets/works/passing-love.png', tags: ['Drama'], category: 'film', productionStage: 'movies-development', description: 'When a woman accidentally discovers her mother has kept the truth of her birth a secret, she travels to Paris to search for the woman who abandoned her.' },
  ...
  { id: 48, title: 'Icky', year: 2026, src: '/assets/works/icky.png', tags: ['Drama'], category: 'series', productionStage: 'series-development', description: 'A character-driven dramatic series in active development.', credits: [{ name: 'Ken Girotti', role: 'director', isHeadline: true }, { name: 'Wendy Coulas', role: 'producer' }] },
