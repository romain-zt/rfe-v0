...
const WORKS_DATA: WorkSeedItem[] = [
  ...
  { id: 47, title: 'The Highlife', year: 2026, src: '/assets/works/high-life.png', tags: ['Drama'], category: 'series', productionStage: 'paid-development', description: "At the world's most exclusive ski resorts, Whistler, the elite descend for indulgence and excess, leaving local ski instructors and staff to clean up the mess – both on and off the slopes. But as tensions build between wealth and those who serve it, not everyone will make it to the season's final run.\n\nCreated by Lauralee Bell, TF1 to co-produce, Ken Girotti and Wendy Coulas set to showrun.", credits: [{ name: 'Lauralee Bell', role: 'creator', isHeadline: true }, { name: 'Ken Girotti', role: 'showrunner' }, { name: 'Wendy Coulas', role: 'showrunner' }], seenOnNames: ['Studio TF1 America', 'A&E Global Media'] },
  ...
  { id: 49, title: 'The Palace', year: 2026, src: '/assets/works/blade.png', tags: ['Drama'], productionStage: 'paid-development', description: "When a hardened New York defense attorney returns to her former elite skating academy to defend a teenage prodigy accused of murder, she's forced to confront the abusive system and buried crimes that shaped her past before it destroys another girl.\n\nBen York Jones set to showrun, based on the novel Blade by Wendy Walker.", credits: [{ name: 'Ben York Jones', role: 'showrunner', isHeadline: true }], seenOnNames: ['A&E Global Media'] },
  { id: 50, title: 'Sick Puppy', year: 2026, src: '/assets/works/sick-puppy.png', tags: ['Drama'], productionStage: 'paid-development', description: "A brilliant but sociopathic psychologist joins an FBI task force to track and dismantle criminalized brainwashing systems, using her unsettling insights to outwit fellow manipulators as she grapples with her own strange and devious impulses.\n\nBen York Jones is set as showrunner.", credits: [{ name: 'Ben York Jones', role: 'showrunner', isHeadline: true }] },
  ...
  { id: 52, title: 'The Chase: The Josephine Wentzel Story', year: 2026, src: '/assets/works/the-chase-josephine-wentzel-story.png', tags: ['True Crime'], productionStage: 'paid-development', description: "THE CHASE follows one mother's attempt to hunt down her daughter's killer, no matter the cost. When her daughter's murder case starts to cool, Josephine takes it into her own hands partnering with the US Marshalls and the FBI to track down her daughter Krystal's killer. She ultimately succeeds in extraditing him from El Salvador to the United States.\n\nHappening in real time, Josephine awaits the trial.\n\nBased on Josephine Wentzel's harrowing memoir of the same name, Jessica Mecklenberg attached to write.", credits: [{ name: 'Jessica Mecklenberg', role: 'writer', isHeadline: true }], seenOnNames: ['FOX', 'A&E Global Media'] },
  { id: 53, title: 'Nasty Business', year: 2026, src: '/assets/works/nasty-business.png', tags: ['Drama'], productionStage: 'paid-development', description: "A documentary that depicts the horrifying true story currently making its way through the Canadian legal system.\n\nNASTY BUSINESS tells the story of how Robert G. Miller, a reclusive Montréal billionaire, allegedly paid more than 50 young girls for sexual favors from 1996 to 2006. Canada's answer to Jeffery Epstein.", seenOnNames: ['Disney +'] },

  // === MOVIES & FEATURES — IN DEVELOPMENT (Michael's "MOVIES & FEATURES") ===
  { id: 32, title: 'Feather', year: 2026, src: '/assets/works/feather.png', tags: ['Drama'], category: 'film', productionStage: 'movies-development', description: "This never before told story takes you into the dynamic drama of Farrah Fawcett's life and legacy.\n\nWritten by Vernon Scott and co-produced by Latigo Films.", credits: [{ name: 'Vernon Scott', role: 'writer', isHeadline: true }, { name: 'Latigo Films', role: 'co-producer' }] },
  ...
  { id: 1, title: 'Margret & Stevie', year: 2026, src: '/assets/works/margret-stevie.png', tags: ['Drama'], category: 'film', productionStage: 'movies-development', description: "Publishers are circling, eager to rewrite Curious George's co-creator Margret Rey's legacy—but as they close in, so do the memories of the war she survived decades earlier. In her chain-smoking, foul mouthed dog walker Stevie, Margret finds an unlikely friend—and a spark of renewed hope to fight back.\n\nMatthew Weiner, creator of Mad Men, set to direct. Stephenie Gillis to pen the script. Shirley MacLaine attached to star.", credits: [{ name: 'Matthew Weiner', role: 'director', note: 'creator of Mad Men', isHeadline: true }, { name: 'Stephenie Gillis', role: 'writer' }, { name: 'Shirley MacLaine', role: 'star' }] },
  ...
  { id: 48, title: 'Icky', year: 2026, src: '/assets/works/icky.png', tags: ['Drama'], category: 'series', productionStage: 'series-development', description: 'I Could Kill You ("ICKY") is a dark comedy about a suburban mom, Helena Lepinski, who navigates a police investigation, invasive siblings, and her own escalating paranoia as she tries to determine whether she was justified in killing her abusive, narcissistic father — or if she\'s a psychopath like him. ICKY poses the question: are all parents worthy of love and compassion?', credits: [{ name: 'Ken Girotti', role: 'writer', isHeadline: true }, { name: 'Wendy Coulas', role: 'writer' }] },
  { id: 8, title: 'Diamonds and Deadlines', year: 2026, src: '/assets/works/diamonds-and-deadlines.png', tags: ['Drama'], category: 'series', productionStage: 'series-development', description: 'This is the true story of Miriam Leslie. The product of her father and one of his slaves. A true renaissance woman, Miriam made her way to the top of the publishing world, a male-dominated industry, becoming one of the wealthiest women in the United States in the late 1800s.\n\nUpon her death she left her multi-million-dollar estate (roughly 50 million dollars today) to the suffragists — a contribution that would ensure the passage of the Nineteenth Amendment.\n\nNicole Ari Parker attached to star, Susan Fales-Hill attached to showrun.', credits: [{ name: 'Nicole Ari Parker', role: 'star', isHeadline: true }, { name: 'Susan Fales-Hill', role: 'showrunner' }] },
  ...
  { id: 29, title: 'An Iron Man', year: 2025, src: '/assets/works/iron-man.png', tags: ['Drama'], category: 'film', productionStage: 'movies-development', description: "AN IRON MAN is the true story of the first ever Ironman champion with Down Syndrome and the father who would do anything to give his special-needs son a chance to achieve his dreams against all odds.\n\nBased on Chris and Nik Nikic's memoir. Bobby Hanaford to pen the script. Josh Bachove, producer of Minari, attached to co-produce.", credits: [{ name: 'Bobby Hanaford', role: 'writer', isHeadline: true }, { name: 'Josh Bachove', role: 'co-producer', note: 'producer of Minari' }] },
