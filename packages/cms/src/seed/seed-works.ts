...
const WORKS_DATA: WorkSeedItem[] = [
  ...
  { id: 14, title: 'Trans Electric', year: 2026, src: '/assets/posters/TransElectric2.png', tags: ['Drama'], description: "From the depths of the '70s rock 'n' roll excesses, Cidny Bullen's compelling journey about finding your authentic voice." },
  ...
  { id: 46, title: 'Husband Father Killer', year: 2024, src: '/assets/posters/HusbandFatherKiller.jpeg', tags: ['Thriller'], description: 'Based on the horrific true story of Alyssa Pladl, Elisabeth Rohm directed and executive produced the film alongside Kara Feifer. Debuted on Lifetime on October 19, 2024.' },
  ...
  { id: 30, title: 'Our Daughter Has Disappeared', year: 2026, src: '/assets/posters/SusanPowell.jpg', tags: ['True Crime'], category: 'film', description: "When Susan Powell goes missing in December of 2009, the media is swept up into the story. Based on the book \"If I Can't Have You\" by Gregg Olsen and Rebecca Morris." },
  { id: 31, title: 'A Dentist to Die For', year: 2026, src: '/assets/posters/a-dentist-to-die-for.png', tags: ['True Crime'], category: 'film', description: 'Dental surgeon Dr. James Ryan becomes dangerously obsessed with beauty queen Sarah Harris, manipulating her with surgical-grade narcotics.' },
  { id: 1, title: 'Margret & Stevie', year: 2026, src: '/assets/works/margret-stevie.png', tags: ['Drama'], category: 'film', description: "Publishers are circling, eager to rewrite Curious George's co-creator Margret Rey's legacy — but as they close in, so do the memories of the war she survived decades earlier. Starring Shirley MacLaine, directed by Matthew Weiner." },
  { id: 32, title: 'Feather', year: 2026, src: '/assets/posters/Feather_Farah.png', tags: ['Drama'], category: 'film', description: "The never before told story of Farrah Fawcett's life and legacy. Written by Vernon Scott, co-produced by Latigo Films." },
  { id: 9, title: 'Flower Girl', year: 2025, src: '/assets/works/flower-girl.png', tags: ['Drama'], category: 'film', description: 'The story of Virginia Cherrill, the leading lady of "City Lights" — about the severe consequences she suffered for refusing Chaplin\'s advances.' },
  { id: 33, title: 'Murder-in-Law', year: 2026, src: '/assets/posters/murder-in-law.png', tags: ['True Crime'], category: 'film', subcategory: 'true-crime-movies', description: "A wealthy Miami matriarch. A bitter custody war. A hitman's bullet. What began as the cold-blooded assassination of a Florida law professor spiraled into one of the most shocking family-driven murder plots in America." },
  ...
  { id: 35, title: 'Undefeated', year: 2026, src: '/assets/posters/Undefeated.jpg', tags: ['Drama'], category: 'series', description: "Inside the Miami Dolphins' 1972 comeback from three straight championship losses to an undefeated season. Based on Mike Freeman's book." },
  { id: 8, title: 'Diamonds and Deadlines', year: 2026, src: '/assets/works/diamonds-and-deadlines.png', tags: ['Drama'], category: 'series', description: 'The true story of Miriam Leslie, who made her way to the top of the publishing world and left her multi-million-dollar estate to the suffragists.' },
  { id: 7, title: "Two's Company", year: 2025, src: '/assets/works/twos-company.png', tags: ['Drama'], category: 'series', description: 'From a shattered childhood to the heights of fame and reinvention, Suzanne Somers fights to own her voice and her legacy.' },
  ...
  { id: 5, title: "The Lobotomist's Wife", year: 2026, src: '/assets/works/lobotomist-wife.png', tags: ['Drama'], category: 'series', subcategory: 'true-crime-series', description: 'A devoted mental health advocate falls for a brilliant but radical lobotomy pioneer, only to discover his "miracle cure" is leading to horrific results.' },
  ...
  { id: 23, title: 'Lie Detector', year: 2025, src: '/assets/works/lie-detector.png', tags: ['Thriller'], category: 'series', subcategory: 'dramas-series', description: 'When the FBI unveils VERA, a cutting-edge lie detector considered to be infallible, Master Interrogator Kara Voss and her team are tasked with proving it.' },
  ...
  { id: 42, title: 'Dispatch', year: 2026, src: '/assets/posters/dispatch.png', tags: ['Thriller'], category: 'series', subcategory: 'dramas-series', description: 'When a late-night call ends in a fiery truck crash, a small-town dispatcher teams up with local police to uncover a deadly cover-up. Co-production with TF1 America.' },
